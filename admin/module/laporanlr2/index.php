    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="row" style="margin-left:1pc;margin-right:1pc;">
         ...
         <div class="col-sm-11">
          <a href="index2.php?page=laporanlr2" id="tombol" class="btn btn-info pull-left"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Kembali</a>
          <a href="print3.php" target="_blank"> <button class="btn btn-warning pull-right"><i class="fa fa-print"></i> Cetak</button></a>
           </div>';
                                }
