 		...
 		<div class="row">
 			<div class="col-lg-12 main-chart">
 				...
 				<div class="col-sm-4">
 					<div class="panel panel-primary">
 						<div class="panel-heading">
 							<h4><i class="fa fa-lock"></i> Login Data</h4>
 						</div>
 						<div class="panel-body">
 							<div class="box-content">
 								<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?auth=edit-data">
 									...
 									<fieldset>
 										<div class="control-group">
 											...
 											<div class="input-group">
 												...
 												<input type="text" class="form-control" style="border-radius:0px;" name="user" data-items="4" placeholder="Username" value="" />
 											</div>
 										</div>
 										<div class="control-group">
 										...
 										<div class="control-group">
 											...
 											<div class="input-group">
 												...
 												<input type="text" class="form-control" style="border-radius:0px;" name="id" value="<?php echo $hasil['id_member']; ?>" required="required" readonly='true' />
 											</div>
 										</div>
 										<br>
 										<div class="pull-right">
 											...
 											<button type="submit" class="btn btn-primary" value="Tambah" style="border-radius:0px;" name="proses"><i class="fa fa-pencil"></i> Ubah Data</button>
 										</div>
 									</fieldset>
 								</form>
 							</div>
